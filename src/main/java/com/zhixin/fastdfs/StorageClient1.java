 ...
 * <p>
 * FastDFS Java Client may be copied only under the terms of the GNU Lesser General Public License (LGPL). Please visit
...
public class StorageClient1 extends StorageClient {
     ...
     *        <ul>
     *        <li>ProtoCommon.STORAGE_SET_METADATA_FLAG_OVERWRITE: overwrite all old metadata items</li>
     *        </ul>
     *        <ul>
     *        <li>ProtoCommon.STORAGE_SET_METADATA_FLAG_MERGE: merge, insert when the metadata item not exist, otherwise
     *        update it</li>
     *        </ul>
